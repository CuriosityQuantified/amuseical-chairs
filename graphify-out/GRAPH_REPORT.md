...
## Corpus Check
- 85 files · ~134,276 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 715 nodes · 1596 edges · 49 communities (44 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e8a028fb`
...
### Community 0 - "Room"
Cohesion: 0.09
Nodes (6): COMPLETION_MODE, clientScoredGameAllowed(), PER_TURN_SECRET, Room, sanitizeConfig(), attachSockets()
...
### Community 2 - "sockets.js"
Cohesion: 0.36
Nodes (8): clientAddress(), failedJoinAllowed(), failedJoinResponse(), guarded(), publicOrigin(), roomCreateAllowed(), takeRateToken(), withinPayloadLimit()
...
Cohesion: 0.10
Nodes (27): NEEDS_AGGREGATION, cupsCount(), cupsLevel(), cupsSwapMs(), pairsFor(), correct(), cupsRoom(), EXPECTED_MS (+19 more)
...
### Community 38 - "room.js"
Cohesion: 0.20
Nodes (8): COMPETITIVE_CLIENT_SCORING_DISABLED, DEFAULTS, HOST_EDITABLE_CONFIG, makeRoomCode(), newReconnectToken(), pickHostEditableConfig(), reconnectTokenMatches(), io
...
### Community 41 - "Handoff — issue #92"
Cohesion: 0.25
Nodes (7): Blocker, Constraints, Handoff — issue #92, Issue specification, Next action, Required remaining work, Verified repository context
...
### Community 45 - "redemption.test.js"
Cohesion: 0.48
...
## Knowledge Gaps
- **180 isolated node(s):** `graphify-mcp`, `name`, `version`, `description`, `type` (+175 more)
...
- **Why does `Room` connect `Room` to `sockets.js`, `room.js`, `multistage.test.js`, `room.test.js`, `server/games.js`, `reveal.test.js`, `cups.test.js`, `security.test.js`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `attachSockets()` connect `Room` to `sockets.js`, `scripts`, `room.js`, `reveal.test.js`, `security.test.js`?**
...
- **Should `Room` be split into smaller, more focused modules?**
  _Cohesion score 0.09350307287093942 - nodes in this community are weakly interconnected._
