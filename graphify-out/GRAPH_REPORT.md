...
## Corpus Check
- 85 files · ~134,110 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 715 nodes · 1595 edges · 49 communities (44 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4570d630`
...
### Community 2 - "Handoff — issue #90"
Cohesion: 0.25
Nodes (7): Commands and results, Fresh continuation record — 2026-09-02, Graph findings already collected, Handoff — issue #90, Next actions, Required work, State
...
- **Why does `Room` connect `Room` to `room.js`, `multistage.test.js`, `room.test.js`, `sockets.js`, `server/games.js`, `reveal.test.js`, `cups.test.js`, `security.test.js`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `attachSockets()` connect `Room` to `scripts`, `room.js`, `multistage.test.js`, `sockets.js`, `reveal.test.js`, `security.test.js`?**
